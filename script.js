...
const meteoChart = new Chart(ctx, {
    ...
    data: {
        labels: labels48,
        datasets: [
            { label: "Temperatura (°C)", data: temp48, borderColor: "red", tension: 0.3 },
            { label: "Umidità (%)", data: hum48, borderColor: "blue", tension: 0.3 },
            { label: "Pressione (hPa)", data: press48, borderColor: "green", tension: 0.3 }
        ]
    }
});
